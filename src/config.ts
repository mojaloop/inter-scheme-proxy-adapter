...
const config = convict<AppConfig>({
  ...
  peerAConfig: {
    ...
    controlAgentConfig: {
      ...
      connectionTimeout: {
        doc: 'Connection timeout for control agent A',
        format: Number,
        default: 4000,
        env: 'MGMT_API_WS_CONNECTION_TIMEOUT_A',
      },
      timeout: {
        doc: 'Message timeout for control agent A',
        format: Number,
        default: 5000,
  ...
  peerBConfig: {
    ...
    controlAgentConfig: {
      ...
      connectionTimeout: {
        doc: 'Connection timeout for control agent B',
        format: Number,
        default: 4000,
        env: 'MGMT_API_WS_CONNECTION_TIMEOUT_B',
      },
      timeout: {
        doc: 'Message timeout for control agent B',
        format: Number,
        default: 5000,
